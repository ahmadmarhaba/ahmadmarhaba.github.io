    ...
    <>
      ...
      <li>
        <ul className='detailList'>
          ...
          <li className='split'>
            <span>{`As my title shows, I work as a full stack developer from making front end to back end development with CI/CD integration. I don’t mind relocating to any other location the company wants. Finally, to discuss further your job requirements and my qualifications, I am available anytime, at your convenience, for a meeting. Should any references or any further information be required, please do not hesitate to contact me at the email from my resume section.`}</span>
          </li>
          <li className='split'>
